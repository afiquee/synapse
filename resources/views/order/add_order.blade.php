                    ...
                    <div class="rows">
                        <div class="cols">
                            ...
                            <input name="phone" id="phone"
                                class="input-text @error('phone') is-invalid @enderror" value="{{ old('phone') }}"
                                type="text" placeholder="Phone Number" required onkeyup="checkExistingCustomer()"/>
                            @error('phone')
                    ...
                    <div class="rows">
                        <div class="cols">
                            ...
                            <input name="full_name" id="full_name"
                                ...
                                value="{{ old('full_name') }}" type="text" placeholder="Full Name" required disabled />
                            @error('full_name')
                            <label class="label-error">{{ $message }}</label>
                            @enderror
                        </div>
