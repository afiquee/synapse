        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    ...
                    <button class="btn btn-green" data-id="#myModal" onclick="openModal('registerModal')"><i class="fas fa-plus"></i>Add
                        User</button>
                </div>
            ...
            <form id="registerForm" method="POST" onsubmit="event.preventDefault(); registerUser()">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input name="email" id="email" class="input-text" value="{{ old('email') }}" type="text" placeholder="Email" required />
        ...
        <div class="modals-content">
            <form id="updateForm" method="POST" onsubmit="event.preventDefault(); updateUser()">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label class="input-label" for="email">Email</label>
                        <input name="u_email" id="u_email" class="input-text" value="{{ old('email') }}" type="text" placeholder="Email" required />
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
